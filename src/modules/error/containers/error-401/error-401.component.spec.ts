...
@Component({
    template: `
        <vc-error-401 [someInput]="someInput" (someFunction)="someFunction($event)"></vc-error-401>
    `,
})
...
describe('Error401Component', () => {
    ...
    it('should display the component', () => {
        expect(hostComponentNE.querySelector('vc-error-401')).toEqual(jasmine.anything());
    });
});
